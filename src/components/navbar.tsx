    ...
    <nav className="relative" ref={navRef}>
      ...
      <div>
        <button
          ...
          className="w-38  md:w-64 lg:w-64 p-3 mt-4 mb-0 rounded-xl bg-white/25 backdrop-blur-md text-gray-800 font-semibold text-lg shadow-lg hover:bg-white/35 hover:-translate-y-0.5 hover:shadow-xl active:translate-y-0 active:shadow-md transition-all duration-200 ease-out"
        >
          Menu
        </button>
      </div>
